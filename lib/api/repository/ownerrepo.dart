...
class OwnerRepo {
  ...
  Future<BaseModel<RegistrationResponse>> register(String name, String phone, String email, String password, String fcm_token, double latitude, double longitude, int valueType) async {
    RegistrationResponse response;
    try {
